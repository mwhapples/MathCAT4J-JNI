...
#[no_mangle]
pub extern "system" fn Java_onl_mdw_mathcat4j_MathKat_getVersion(env: JNIEnv, _obj: JObject) -> jstring {
    env.new_string(get_version()).expect("Could not create java string").into_inner()
}

#[no_mangle]
pub extern "system" fn Java_onl_mdw_mathcat4j_MathKat_setRulesDir(env: JNIEnv, _obj: JObject, dir: JString) {
...
#[no_mangle]
pub extern "system" fn Java_onl_mdw_mathcat4j_MathKat_setPreference(env: JNIEnv, _obj: JObject, name: JString, value: JString) {
...
#[no_mangle]
pub extern "system" fn Java_onl_mdw_mathcat4j_MathKat_getPreference(env: JNIEnv, _obj: JObject, name: JString) -> jstring {
    let name = env.get_string(name).expect("Could not get string for name").into();
    let result = get_preference(name);
    get_string_or_throw(env, result)
}
#[no_mangle]
pub extern "system" fn Java_onl_mdw_mathcat4j_MathKat_setMathml(env: JNIEnv, _obj: JObject, mathml_str: JString) -> jstring {
...
#[no_mangle]
pub extern "system" fn Java_onl_mdw_mathcat4j_MathKat_getBraille(env: JNIEnv, _obj: JObject, navigation_id: JString) -> jstring {
